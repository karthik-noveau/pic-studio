...
import CropPreview from "../tabs/crop/preview";
...
export default function PreviewPanel({
  ...
  const { processedImageUrl } = useStore(); // Get processedImageUrl from store
      ...
      <div className={styles.previewHeader}>
        ...
        <div className={styles.headerRight}>
          <Button
            icon={<Undo size={16} />}
            onClick={undo}
            disabled={!useStore.temporal.getState().pastStates.length}
          >
            Undo
          </Button>
          <Button
            icon={<Redo size={16} />}
            onClick={redo}
            disabled={!useStore.temporal.getState().futureStates.length}
          >
            Redo
          </Button>
      ...
      {activeTool === "analysis" && imageData && (
        <div className={styles.previewContainer}>
          <div className={styles.imageWrapper}>
            <img
              src={processedImageUrl || imageData.src}
        ...
        <div className={styles.compressComparisonSection}>
          ...
          <div className={styles.comparisonSlider}>
            {compressedImageSrc && compressedSize ? (
              <ComparisonSlider
                originalSrc={processedImageUrl || imageData.src}
