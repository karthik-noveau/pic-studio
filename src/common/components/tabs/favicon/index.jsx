...
import { faviconSizes } from "@common/constants";
...
export default function FaviconTab({ isBulkMode }) {
  ...
  return (
    <div className={styles.container}>
      <TabSection
        ...
        iconColorClass={styles.yellowIcon}
      >
        <div>
          ...
          <div className={styles.faviconGrid}>
            {faviconSizes.map((favicon) => (
              <div key={favicon.size} className={styles.faviconItem}>
                <Switch
        ...
        <Button
          ...
          disabled={selectedFaviconSizes.length === 0 || isBulkMode}
          size="large"
